...
const styles = StyleSheet.create({
    ...
    header: { fontSize: 32, fontWeight: 'bold', marginBottom: 30, color: '#111827' },
    groupContainer: { marginBottom: 30 },
    groupTitle: { fontSize: 14, fontWeight: '600', color: '#6B7280', textTransform: 'uppercase', marginBottom: 10, paddingHorizontal: 16 },
    groupItems: { backgroundColor: '#FFFFFF', borderRadius: 16 },
    itemContainer: { flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#F3F4F6' },
    itemLabel: { flex: 1, marginLeft: 16, fontSize: 16, color: '#374151' },
    logoutButton: { backgroundColor: '#FFFFFF', padding: 15, borderRadius: 10, alignItems: 'center' },
